...
const UserProfile = () => {
  ...
  useEffect(() => {
    const apiCall = setTimeout(() => {
      axios.get("https://api.github.com/users/Ermaurya").then((res) => setData(res.data));
      axios.get("https://api.github.com/users/Ermaurya/repos").then((res) => setRepos(res.data));
    }, 1500);
