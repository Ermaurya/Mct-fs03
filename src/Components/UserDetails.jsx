            ...
            <div className="items-center flex flex-col mb-5 px-5 h-auto">
                ...
                {data.length !== 0 ? (
                    <>
                        ...
                        <div className="card lg:card-side card-bordered border-white flex md:px-5 py-5 w-full md:w-5/12 bg-color">
                            ...
                            <div className="card-body flex items-center p-0 sm:p-5">
                                ...
                                <div className="card-actions">
                                    <a href={`${data.html_url}`} className="btn btn-outline flex ">
