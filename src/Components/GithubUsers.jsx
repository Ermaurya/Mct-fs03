...
const GithubUsers = ({users}) => {
    return (
        <div>
            <h2 className='hading'>List of GitHub Users</h2>
            <div className="container-fluid mt-5">
                    ...
                    
                {
                        ...
                        users.map((curElem) => {
                        console.log(curElem);
                            const { avatar_url, id, login, full_name } = curElem;
                        return (
                              <div className="col-10 col-md-4 mt-5" key={id}>
                      <div className="card p-2">
                      <Link to={`/${curElem.login}`} >
                                <div className="d-flex align-items-center">
                                        <div className="image"> <img src={ avatar_url } className="rounded" width="155" /> </div>
                                    <div className="ml-3 w-100">
                                            <h4 className="d-flex mb-0 mt-0 textLeft">{login} <FcApproval/> </h4>
                                            <span className="text-left">{full_name }</span>
